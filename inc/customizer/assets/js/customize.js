( function( $ ) {
    /************************************************
    * Boxshadow WP Customize Panel And Section
    *************************************************/
    ...
    api.bind( 'pane-contents-reflowed', function() {
        ...
        api.section.each( function( section ) {
            ...
            if ( 'boxshadow_section' !== section.params.type || 'undefined' === typeof section.params.section ) {
                return;
            }
        ...
        api.panel.each( function( panel ) {
            ...
            if ( 'boxshadow_panel' !== panel.params.type || 'undefined' === typeof panel.params.panel ) {
                return;
            }
    ...
    wp.customize.Panel = wp.customize.Panel.extend({
        attachEvents: function() {
            ...
            if ( 'boxshadow_panel' !== this.params.type || 'undefined' === typeof this.params.panel ) {
        ...
        isContextuallyActive: function() {
            ...
            if ( 'boxshadow_panel' !== this.params.type) {
    ...
    wp.customize.Section = wp.customize.Section.extend({
        attachEvents: function() {
            ...
            if ( 'boxshadow_section' !== this.params.type || 'undefined' === typeof this.params.section ) {
        ...
        isContextuallyActive: function() {
            ...
            if ( 'boxshadow_section' !== this.params.type ) {
...
jQuery( document ).ready(function( $ )  {
    ...
    /************************************************
    *Boxshadow TinyMCE Custom Control Class 
      *************************************************/
    $('.customize-control-tinymce-editor').each(function() {
        // Get the toolbar strings that were passed from the PHP Class
        var tinyMCEToolbar1String = _wpCustomizeSettings.controls[$(this).attr('id')].Boxshadowtinymcetoolbar1;
        var tinyMCEToolbar2String = _wpCustomizeSettings.controls[$(this).attr('id')].Boxshadowtinymcetoolbar2;
        var tinyMCEMediaButtons = _wpCustomizeSettings.controls[$(this).attr('id')].Boxshadowmediabuttons;
